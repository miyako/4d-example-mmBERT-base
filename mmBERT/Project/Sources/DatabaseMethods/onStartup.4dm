...
$folder:=$homeFolder.folder("mmBERT-base")
$path:="mmBERT-Base-Q8_0.gguf"
$URL:="keisuke-miyako/mmBERT-base-gguf-q8_0"
...
$folder:=$homeFolder.folder("mmBERT-base")
$path:="mmBERT-base-onnx-int8"
$URL:="keisuke-miyako/mmBERT-base-onnx-int8"
